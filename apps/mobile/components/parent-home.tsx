...
const styles = StyleSheet.create({
  ...
  sessionRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 14, borderBottomColor: colors.border, borderBottomWidth: 1 },
  ...
  openText: { ...typography.bodyBold, color: colors.success, fontSize: 12 },
