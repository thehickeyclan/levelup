-- Guild messaging tables for listing Q&A, offers, orders, trades.
-- Run in Supabase Dashboard → SQL Editor if listing questions fail.
...
-- Optional: live updates in the thread UI
